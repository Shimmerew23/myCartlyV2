...
const errorHandler = (err, req, res, next) => {
  ...
  if (statusCode >= 500) logger.error(`${statusCode} - ${err.message} - ${req.originalUrl}`);
...
module.exports = {
  authenticate, requireSeller, requireAdmin, globalLimiter,
  mongoSanitize, httpLogger, addRequestMetadata, performanceTiming, notFound, errorHandler,
};
